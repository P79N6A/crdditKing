            ...
            <el-row>
                <el-form :inline="true" :model="queryMap" class="demo-form-inline" label-width="100px">
                    <el-row>
                        <el-col :span="3">
                            <el-form-item label="">
                                <el-input v-model="queryMap.key" placeholder="請輸入電子貨幣信用卡名稱" clearable></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                            <el-form-item label=" ">
                                ...
                                <el-button type="primary" @click="ecardInsert">
            ...
            <el-row>
                <el-col>
                    <el-table :data="tableData" border style="width: 80%">
                        ...
                        <el-table-column prop="emoneyName" label="電子貨幣包名稱" align="center" ></el-table-column>
                        <el-table-column prop="name" label="電子貨幣信用卡" align="center" ></el-table-column>
                        <el-table-column prop="rebateMileage" label="回贈里數" align="center" ></el-table-column>
                        <el-table-column prop="tallRebate" label="最高回贈(每月每年)" align="center" ></el-table-column>
...
export default {
  ...
  methods: {
    ...
    toDelete(row){
      ...
      this.$confirm("是否確認對該電子貨幣信用卡進行" + visibtext + "操作", "提示", {
        ...
        type: "warning"
          ...
          this.$post("eCardSave", { id: row.id, deleted: deleted }).then(res => {
            this.getTableData();
    ...
    getTableData() {
      ...
      this.$post("eCardList", this.queryMap)
        .then(res => {
