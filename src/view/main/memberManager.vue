            ...
            <el-row>
                <el-col>
                    <el-table :data="tableData" border style="width: 80%">
                        ...
                        <el-table-column prop="integral" label="積分" align="center" ></el-table-column>
                        <el-table-column prop="createTime" label="加入時間" align="center">
    ...
    toDelete(row){
      ...
      this.$confirm("是否確認對該會員進行" + visibtext + "操作", "提示", {
        ...
        type: "warning"
          ...
          this.$post("memberSave", { id: row.id, deleted: deleted }).then(res => {
            this.getTableData();
