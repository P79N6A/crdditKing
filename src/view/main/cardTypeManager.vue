                    ...
                    <el-row>
                        ...
                        <el-col :span="5">
                            <el-form-item label=" ">
                                ...
                                <el-button type="primary" @click="cardTypeInsert">
            ...
            <el-row>
                <el-col>
                    <el-table :data="tableData" border style="width: 80%">
                        ...
                        <el-table-column prop="detail" label="簡介" align="center" :show-overflow-tooltip="true"></el-table-column>
    ...
    toDelete(row){
      ...
      this.$confirm("是否確認對該信用卡類型進行" + visibtext + "操作", "提示", {
        ...
        type: "warning"
          ...
          this.$post("cardTypeSave", { id: row.id, deleted: deleted }).then(res => {
            this.getTableData();
