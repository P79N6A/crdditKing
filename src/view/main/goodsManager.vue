            ...
            <el-row>
                <el-form :inline="true" :model="queryMap" class="demo-form-inline" label-width="100px">
                    <el-row>
                        <el-col :span="3">
                            <el-form-item label="">
                                <el-input v-model="queryMap.key" placeholder="請輸入禮物名稱" clearable></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                            <el-form-item label=" ">
            ...
            <el-row>
                <el-col>
                    <el-table :data="tableData" border style="width: 80%">
                        ...
                        <el-table-column prop="url" label="禮物圖片"  align="center" width="180px;">
                          <template slot-scope="scope">
                              <img v-if="scope.row.url" :src="scope.row.url" style="width:50px;height:50px;">
                          </template>
                        </el-table-column>
                        <el-table-column prop="name" label="禮物名稱" align="center" ></el-table-column>
                        <el-table-column prop="integral" label="兌換積分" align="center" ></el-table-column>
...
export default {
  ...
  methods: {
    ...
    toDelete(row){
      ...
      this.$confirm("是否確認對該禮物進行" + visibtext + "操作", "提示", {
        ...
        type: "warning"
          ...
          this.$post("goodsSave", { id: row.id, deleted: deleted }).then(res => {
            this.getTableData();
    ...
    getTableData() {
      ...
      this.$post("goodsList", this.queryMap)
        .then(res => {
