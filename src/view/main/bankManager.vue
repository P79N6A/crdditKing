            ...
            <el-row>
                <el-form :inline="true" :model="queryMap" class="demo-form-inline" label-width="100px">
                    <el-row>
                        <el-col :span="3">
                            <el-form-item label="">
                                <el-input v-model="queryMap.name" placeholder="請輸入銀行名稱" clearable></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="5">
                            <el-form-item label=" ">
                                ...
                                <el-button type="primary" @click="bankInsert">
            ...
            <el-row>
                <el-col>
                    <el-table :data="tableData" border style="width: 80%">
                        ...
                        <el-table-column prop="logo" label="銀行logo"  align="center" width="180px;">
                          <template slot-scope="scope">
                              <img v-if="scope.row.logo" :src="scope.row.logo" style="width:150px;height:50px;">
                          </template>
                        </el-table-column>
                        <!-- <el-table-column prop="banner" label="圖片鏈接"  align="center" width="180px;">
                          <template slot-scope="scope">
    ...
    toDelete(row){
      ...
      this.$confirm("是否確認對該銀行進行" + visibtext + "操作", "提示", {
        ...
        type: "warning"
          ...
          this.$post("bankSave", { id: row.id, deleted: deleted }).then(res => {
            this.getTableData();
