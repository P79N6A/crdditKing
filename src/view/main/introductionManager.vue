                    ...
                    <el-table :data="tableData" border style="width: 80%">
                        ...
                        <el-table-column prop="url" label="圖片"  align="center" width="180px;">
                          <template slot-scope="scope">
                              <img v-if="scope.row.url" :src="scope.row.url" style="width:100px;height:150px;">
                          </template>
                        </el-table-column>
                        <el-table-column prop="name" label="名稱" align="center" ></el-table-column>
                        <el-table-column prop="sort" label="排序" align="center" ></el-table-column>
                        <el-table-column prop="rotationTime" label="輪換時間" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    toDelete(row){
      ...
      this.$confirm("是否確認對該引導頁進行" + visibtext + "操作", "提示", {
        ...
        type: "warning"
          ...
          this.$post("introductionSave", { id: row.id, deleted: deleted }).then(res => {
            this.getTableData();
    ...
    getTableData() {
      ...
      this.$post("introductionList", this.queryMap)
        .then(res => {
