...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getTableData: function getTableData() {
      ...
      var loadingInstance = __WEBPACK_IMPORTED_MODULE_1_element_ui__["Loading"].service({ fullscreen: true });
      this.$post("collectList", this.queryMap).then(function (res) {
  ...
  methods: {
    ...
    toDelete: function toDelete(row) {
      ...
      this.$confirm("是否確認對該商戶進行" + visibtext + "操作", "提示", {
        ...
        _this2.$post("merchantSave", { id: row.id, deleted: deleted }).then(function (res) {
          _this2.getTableData();
          _this2.$message({ message: "操作成功",
            type: "success",
            center: true });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('ui-layout', {
    ...
    scopedSlots: _vm._u([{
      key: "default",
      fn: function(scope) {
        return [_c('span', [_vm._v(_vm._s(_vm._f("dateFmt")(scope.row.collectTime, 'yyyy-MM-dd')))])]
      }
    }])
  })], 1)], 1)], 1), _vm._v(" "), _c('el-row', [_c('ui-page', {
    attrs: {
