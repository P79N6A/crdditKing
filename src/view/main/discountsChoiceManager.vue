                    ...
                    <el-row>
                        ...
                        <el-col :span="5">
                            <el-form-item label=" ">
                                ...
                                <el-button type="primary" @click="discountsChoiceInsert">
            ...
            <el-row>
                <el-col>
                    <el-table :data="tableData" border style="width: 80%">
                        ...
                        <el-table-column prop="detail" label="優惠詳情" align="center" :show-overflow-tooltip="true"></el-table-column>
                        <el-table-column prop="discountsTime" label="優惠時間" align="center">
                            <template slot-scope="scope">
                                <span>{{scope.row.discountsTime | dateFmt('yyyy-MM-dd')}}</span>
                            </template>
                        </el-table-column>
                        <el-table-column label="操作" width="300" fixed="right" align="center">
                            <template slot-scope="scope">
                                <el-button type="text" size="small" @click="toDelete(scope.row)" v-text="scope.row.deleted == 'N' ? '刪除' : '已删除'"></el-button>
                                <el-button type="text" size="small" @click="discountsChoiceDetail(scope.row)" style="margin-left:10px;">編輯</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </el-col>
...
export default {
  ...
  methods: {
     //跳转新增页
    discountsChoiceInsert() {
      this.$to({ name: "discountsChoiceInsert" });
    },
    //编辑
    discountsChoiceDetail(row){
    ...
    toDelete(row){
      ...
      this.$confirm("是否確認對該信用卡優惠進行" + visibtext + "操作", "提示", {
        ...
        type: "warning"
          ...
          this.$post("discountsChoiceSave", { id: row.id, deleted: deleted }).then(res => {
            this.getTableData();
